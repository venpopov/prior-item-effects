...
study = study.sort_values(by=['subject','trial'])
...
trials = trials.sort_values(by=['subject','procedure','trial'])
...
#%%
init_pars['p'] = 0.5528
init_pars['p_additional'] = 0.5528
init_pars['w_recovery_rate'] = 0.53
...
#%%
init_pars['w_recovery_rate'] = 0.51
model = sac.fit_model_group.Model(nets=nets, 
                        init_pars=init_pars, 
                        par_names=['w_recovery_rate'],
                        par_ranges={'w_recovery_rate': slice(0.5,0.55,0.01),
...
#results.to_csv('output/marevic2017_results_fit.csv')
